    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-4 text-center text-sm text-gray-500">
          ...
          <Link href={callbackUrl !== "/workspaces" ? `/register?callbackUrl=${encodeURIComponent(callbackUrl)}` : "/register"} className="font-medium text-gray-900 underline hover:text-gray-700">
            Sign up
          </Link>
        </p>
      </div>
